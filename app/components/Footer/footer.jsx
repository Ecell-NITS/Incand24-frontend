    ...
    <div className={styles.body}>
      <div className={styles.container}>
        <div className={styles.bglogo}>
          <Image src="/Group 5226.png" alt="" width={500} height={400} />
        </div>
        <div className={styles.top}>
          <div className={styles.top1}>
            <div className={styles.top_tittle}>
              <a href="https://www.example.com">BROCHURE</a>
            </div>
            <p
              className={styles.p}
              alt='"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum'
            >
          ...
          <div className={styles.top2}>
            ...
            <a
              href="mailto:incand@gmail.com"
              alt="incand@gmail.com"
        ...
        <div className={styles.bottom}>
          <div className={styles.bottom1}>
            <a href="https://www.example.com" className={styles.icons}>
              {" "}
            ...
            >
              <path
                d="M2.98535 3L273.015 3"
                stroke="url(#paint0_linear_957_1213)"
                stroke-width="5"
                stroke-linecap="round"
              />
              <defs>
                <linearGradient
                  id="paint0_linear_957_1213"
                  x1="142.527"
                  y1="3.72368"
                  x2="171.433"
                  y2="-59.6226"
          ...
          <div className={styles.bottom2}>
            <div className={styles.bottom2_1}>
              NIT SILCHAR
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="276"
            ...
            <div className={styles.bottom2_2}>
              NIT Road, Fakirtilla, Silchar, Assam, 788010
            </div>
          </div>
        </div>
      </div>
